# `spiders/orchestration/page_visitor.py`
...
`docs/dev/spiders/orchestration/mechanical_loop.md#_worker`) already knows what to do
...
see `docs/dev/spiders/orchestration/visit_result.md#componentinteractionaction`) so a
...
`visit()` itself. See `docs/dev/spiders/orchestration/mechanical_loop.md#_worker` and
`docs/dev/spiders/orchestration/mechanical_loop.md#_recycle_session_if_due`.
...
`docs/dev/spiders/orchestration/mechanical_loop.md#crawl_site` on why that would reset
...
`docs/dev/spiders/orchestration/mechanical_loop.md#crawl_site`'s requeue logic and
`docs/dev/spiders/orchestration/graph_sink.md#record_page_finished`), not be marked
...
`docs/dev/spiders/orchestration/mechanical_loop.md#_worker`, defaulted to `url` here
...
`docs/dev/spiders/orchestration/mechanical_loop.md#_recycle_session_if_due` for where
