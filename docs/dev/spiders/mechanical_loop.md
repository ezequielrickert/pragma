...
`docs/dev/spiders/page_visitor.md` for why it persists across visits
within one crawl).
...
way per-visit closing (`docs/dev/spiders/crawl4ai_crawler.md#close_session`,
...
`docs/dev/spiders/page_visitor.md#visit-session-close` for why a resumed
