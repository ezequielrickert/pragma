...
class PragmaConfig:
    ...
    documents: List[str] = field(default_factory=lambda: ["coverage", "architecture", "prd", "tree", "openapi", "catalog", "tokens", "data-model", "flows", "usability", "accessibility", "gherkin", "evidence-log", "change-log", "glossary", "redaction-log"])
