...
Details: docs/dev/database/neo4j_text_content_store.md#module
"""
...
class _Neo4jTextContentMixin:
    """Details: docs/dev/database/neo4j_text_content_store.md#_neo4jtextcontentmixin"""
    ...
    def record_text_contents(self, site: str, page_url: str, entries: List[Dict[str, Any]]) -> None:
        ...
        Details: docs/dev/database/neo4j_graph_store.md#record_text_contents
        """
        if not entries:
            return
        rows = [
