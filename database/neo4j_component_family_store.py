...
Details: docs/dev/database/neo4j_component_family_store.md#module
"""
...
class _Neo4jComponentFamilyMixin:
    """Details: docs/dev/database/neo4j_component_family_store.md#_neo4jcomponentfamilymixin"""
    ...
    def apply_tag_labels(self, site: str, tag_labels: Dict[str, str]) -> None:
        ...
        Details: docs/dev/database/neo4j_graph_store.md#apply_tag_labels
        """
