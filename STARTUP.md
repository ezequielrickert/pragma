...
An internal debugging tool for developers to explore the raw JSON-LD graph ontology (`export.json`) generated by the pipeline.
...
It defaults to `http://localhost:5174`. Open it in your browser and drag/drop or select an `export.json` file from any crawl run (e.g., `data/output/graph-card-verify2/www.empanad.app_export_20260822T231928Z.json`).
