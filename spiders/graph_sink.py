...
Details: docs/dev/spiders/graph_sink.md#module
"""
...
def _option_labels_for(options_json: str) -> List[str]:
    ...
    Details: docs/dev/spiders/graph_sink.md#_option_labels_for
    """
...
def _component_facts(comp: Dict[str, Any]) -> ComponentFacts:
    ...
    Details: docs/dev/spiders/graph_sink.md#_component_facts
    """
...
class GraphStoreInteractionTracker:
    ...
    local read cache. Details: docs/dev/spiders/graph_sink.md#graphstoreinteractiontracker
    """
    ...
    def mark_interacted(self, page_url: str, path: str) -> None:
        ...
        Details: docs/dev/spiders/graph_sink.md#mark_interacted
        """
    ...
    def mark_visited(self, page_url: str) -> None:
        ...
        Details: docs/dev/spiders/graph_sink.md#mark_visited
        """
...
class GraphStoreSink:
    ...
    Details: docs/dev/spiders/graph_sink.md#graphstoresink
    """
    ...
    def __init__(self, graph_store: GraphStore, site: str) -> None:
        ...
        # record_inventory. Details: docs/dev/spiders/graph_sink.md#_resolve_write_path
    ...
    async def _write(self, fn: Callable[..., None], *args: Any, **kwargs: Any) -> None:
        ...
        duration. Details: docs/dev/spiders/graph_sink.md#_write
        """
    ...
    async def record_page_arrival(self, page_key: str, description: str = "", title: str = "") -> None:
        ...
        Details: docs/dev/spiders/graph_sink.md#record_page_arrival
        """
        await self._write(
    ...
    async def record_page_metadata(self, page_key: str, metadata: Dict[str, str]) -> None:
        ...
        Details: docs/dev/spiders/graph_sink.md#record_page_metadata
        """
        if not metadata:
            return
        await self._write(
    ...
    async def record_page_network(self, page_key: str, requests: List[Dict[str, Any]]) -> None:
        ...
        Details: docs/dev/spiders/graph_sink.md#record_page_network
        """
        if not requests:
            return
        await self._write(
    ...
    async def record_text_content(self, page_key: str, text_content: List[Dict[str, Any]]) -> None:
        ...
        Details: docs/dev/spiders/graph_sink.md#record_text_content
        """
        entries = []
    ...
    async def record_inventory(
        ...
        Details: docs/dev/spiders/graph_sink.md#record_inventory
        """
    ...
    def _component_args(self, comp: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        Details: docs/dev/spiders/graph_sink.md#_component_args
        """
        path = comp.get("path")
        if not path:
            return None
    ...
    async def _record_choice_group(
        ...
        Details: docs/dev/spiders/graph_sink.md#_record_choice_group
        """
    ...
    def _resolve_write_path(self, page_key: str, path: str) -> Tuple[str, str]:
        ...
        Details: docs/dev/spiders/graph_sink.md#_resolve_write_path
        """
    ...
    async def record_interaction(
        ...
        Details: docs/dev/spiders/graph_sink.md#record_interaction
        """
    ...
    async def record_component_network(
        ...
        Details: docs/dev/spiders/graph_sink.md#record_component_network
        """
        if step is not None:
            requests = [
    ...
    async def record_revealed_options(self, page_key: str, trigger_path: str, revealed: List[Dict[str, Any]]) -> None:
        ...
        Details: docs/dev/spiders/graph_sink.md#record_revealed_options
        """
    ...
    async def record_page_finished(self, page_key: str, component_count: int) -> None:
        ...
        Details: docs/dev/spiders/graph_sink.md#record_page_finished
        """
        await self._write(
