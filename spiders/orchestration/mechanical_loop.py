...
Details: docs/dev/spiders/orchestration/mechanical_loop.md#module
"""
...
# Details: docs/dev/spiders/orchestration/mechanical_loop.md#_memory_check_interval_seconds
...
# Details: docs/dev/spiders/orchestration/mechanical_loop.md#_memory_wait_timeout_seconds
_MEMORY_WAIT_TIMEOUT_SECONDS = 300.0

# _wait_for_target_capacity's poll interval while a worker is over budget.
# Details: docs/dev/spiders/orchestration/mechanical_loop.md#_target_health_check_interval_seconds
...
class MechanicalCrawlerConfig:
    ...
    Details: docs/dev/spiders/orchestration/mechanical_loop.md#mechanicalcrawlerconfig
    """
    ...
    # Details: docs/dev/spiders/orchestration/mechanical_loop.md#session_recycle_after
    ...
    # Details: docs/dev/spiders/orchestration/mechanical_loop.md#memory_ceiling_percent
    ...
    # Details: docs/dev/spiders/orchestration/mechanical_loop.md#min_page_concurrency
    ...
    # floor. Details: docs/dev/spiders/orchestration/mechanical_loop.md#concurrency_taper
...
class MechanicalCrawler:
    ...
    def __init__(
        ...
        # Details: docs/dev/spiders/orchestration/mechanical_loop.md#tracker-default
        ...
        # Details: docs/dev/spiders/orchestration/mechanical_loop.md#url_frontier
        ...
        # Details: docs/dev/spiders/orchestration/mechanical_loop.md#in_flight
    ...
    def errors(self) -> List[ComponentInteraction]:
        ...
        Details: docs/dev/spiders/orchestration/mechanical_loop.md#errors
        """
    ...
    def _enqueue(self, url: str) -> None:
        ...
        # Details: docs/dev/spiders/orchestration/mechanical_loop.md#_enqueue-scope-gate
    ...
    def _enqueue_links(self, links: List[Dict[str, str]]) -> None:
        ...
        Details: docs/dev/spiders/orchestration/mechanical_loop.md#_enqueue_links
        """
        for link in links:
            href = link.get("href", "")
    ...
    async def crawl_site(self, start_url: str) -> List[PageVisitResult]:
        ...
        Details: docs/dev/spiders/orchestration/mechanical_loop.md#crawl_site
        """
    ...
    async def _recycle_session_if_due(self, browser_session_id: str, visits_since_recycle: int) -> int:
        ...
        Details: docs/dev/spiders/orchestration/mechanical_loop.md#_recycle_session_if_due
        """
    ...
    async def _wait_for_memory_headroom(self) -> None:
        ...
        that ceiling faster. Details: docs/dev/spiders/orchestration/mechanical_loop.md#_wait_for_memory_headroom
        """
    ...
    def _effective_concurrency(self) -> int:
        ...
        Details: docs/dev/spiders/orchestration/mechanical_loop.md#_effective_concurrency
        """
    ...
    async def _wait_for_target_capacity(self, worker_id: int) -> None:
        ...
        Details: docs/dev/spiders/orchestration/mechanical_loop.md#_wait_for_target_capacity
        """
    ...
    async def _worker(self, worker_id: int) -> None:
        ...
        `_recycle_session_if_due`. Details: docs/dev/spiders/orchestration/mechanical_loop.md#_worker
        """
        ...
        while True:
            ...
            try:
                ...
                if result.interrupted_by_navigation:
                    ...
                    # Details: docs/dev/spiders/orchestration/mechanical_loop.md#_worker-requeue
