...
Details: docs/dev/spiders/orchestration/visit_result.md#module
"""
...
class ComponentInteraction:
    ...
    # Details: docs/dev/spiders/orchestration/visit_result.md#componentinteractionstale
    stale: bool = False
...
class PageVisitResult:
    ...
    # Details: docs/dev/spiders/orchestration/visit_result.md#pagevisitresultinterrupted_by_navigation
    interrupted_by_navigation: bool = False
    # Every in-page SPA state this pass switched onto, in order.
    # Details: docs/dev/spiders/orchestration/visit_result.md#pagevisitresultstate_transitions
