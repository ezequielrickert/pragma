...
Details: docs/dev/spiders/orchestration/page_visitor.md#module
"""
...
# never-loading page. Details: docs/dev/spiders/orchestration/page_visitor.md#_max_consecutive_unexplained_failures
_MAX_CONSECUTIVE_UNEXPLAINED_FAILURES = 3


class PageVisitor:
    """Mechanically interacts with one page's frontier, called once per URL.
    Details: docs/dev/spiders/orchestration/page_visitor.md#pagevisitor
    """
    ...
    def __init__(
        ...
        # Details: docs/dev/spiders/orchestration/page_visitor.md#_navigation_trigger_identities
        self._navigation_trigger_identities: Dict[str, Set[tuple]] = {}
        # page_key -> identities ever interacted with, regardless of path.
        # Details: docs/dev/spiders/orchestration/page_visitor.md#_interacted_identities
        self._interacted_identities: Dict[str, Set[tuple]] = {}
        # (page_key, component_identity) -> value already generated for that field.
        # Details: docs/dev/spiders/orchestration/page_visitor.md#_fill_value_cache
    ...
    async def _recover_stale_frontier(
        ...
        Details: docs/dev/spiders/orchestration/page_visitor.md#_recover_stale_frontier
        """
        try:
    ...
    async def _check_for_silent_navigation(
        ...
        Details: docs/dev/spiders/orchestration/page_visitor.md#_check_for_silent_navigation
        """
        try:
    ...
    async def _handle_possible_silent_navigation(
        ...
        Details: docs/dev/spiders/orchestration/page_visitor.md#_handle_possible_silent_navigation
        """
    ...
    async def _transition_to_new_state(
        ...
        Details: docs/dev/spiders/orchestration/page_visitor.md#_transition_to_new_state
        """
        ...
        if self.sink:
            ...
            # Details: docs/dev/spiders/orchestration/page_visitor.md#_transition_to_new_state-finished-check
            if idx >= frontier_len:
        ...
        # Details: docs/dev/spiders/orchestration/page_visitor.md#_transition_to_new_state-frontier-rebuild
    ...
    async def _handle_physical_navigation(
        ...
        Details: docs/dev/spiders/orchestration/page_visitor.md#_handle_physical_navigation
        """
        self._enqueue(new_state.url)
        result.interrupted_by_navigation = True
        # Remember this component's content identity as a proven one-way door.
        # Details: docs/dev/spiders/orchestration/page_visitor.md#_handle_physical_navigation-identity
        self._navigation_trigger_identities.setdefault(page_key, set()).add(component_identity(component))
        if self.sink:
            # A same-route_shape self-loop here is legitimate, not a bug.
            # Details: docs/dev/spiders/orchestration/page_visitor.md#_handle_physical_navigation-self-loop
    ...
    async def _handle_same_page_reveal(
        ...
        Details: docs/dev/spiders/orchestration/page_visitor.md#_handle_same_page_reveal
        """
        if self.sink:
        ...
        # Details: docs/dev/spiders/orchestration/page_visitor.md#_handle_same_page_reveal-revealed-options
        ...
        # Details: docs/dev/spiders/orchestration/page_visitor.md#_handle_same_page_reveal-append-frontier
    ...
    async def _fill_value(self, page_key: str, component: Dict[str, Any], page_description: str) -> str:
        ...
        Details: docs/dev/spiders/orchestration/page_visitor.md#_fill_value
        """
    ...
    def _discovery_failed(self, url: str, exc: Exception) -> PageVisitResult:
        ...
        Details: docs/dev/spiders/orchestration/page_visitor.md#_discovery_failed
        """
    ...
    async def visit(self, url: str, session_id: Optional[str] = None) -> PageVisitResult:  # noqa: C901
        ...
        Details: docs/dev/spiders/orchestration/page_visitor.md#visit
        """
        ...
        # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-step
        ...
        if self.sink:
            ...
            # Details: docs/dev/spiders/orchestration/page_visitor.md#record_page_network
        ...
        # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-known-components
        ...
        frontier: List[Dict[str, Any]] = [
            ...
            # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-content-identity-exclusions
        ...
        # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-max-total-interactions
        ...
        # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-guards
        ...
        while idx < len(frontier) and interactions_done < max_total_interactions:
            ...
            try:
                ...
                # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-except-real-failure
                ...
                if is_element_not_found(exc) and not stale_resynced_since_success:
                    ...
                    # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-except-stale-resync
                ...
                # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-except-not-element-not-found
                ...
                if not silent_navigation_checked_since_success:
                    ...
                    # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-except-silent-nav-check
                ...
                if consecutive_unexplained_failures >= _MAX_CONSECUTIVE_UNEXPLAINED_FAILURES:
                    ...
                    # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-except-circuit-breaker-trip
                    result.interrupted_by_navigation = True
                    break
                continue
            ...
            if new_literal != page_literal:
                ...
                # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-physical-navigation-branch
                ...
                # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-state-transition-branch
                ...
                # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-same-page-branch
        ...
        # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-budget-exhausted
        ...
        if self.sink and not result.interrupted_by_navigation and not result.budget_exhausted_with_frontier_remaining:
            ...
            # Details: docs/dev/spiders/orchestration/page_visitor.md#visit-record-page-finished
            await self.sink.record_page_finished(page_key, len(known_components))
        return result
