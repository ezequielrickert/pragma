...
Details: docs/dev/spiders/orchestration/interaction_tracker.md#module
"""
...
class InteractionTracker(Protocol):
    ...
    GraphStore-backed one. Details: docs/dev/spiders/orchestration/interaction_tracker.md#interactiontracker
    """
...
class InMemoryInteractionTracker:
    ...
    Details: docs/dev/spiders/orchestration/interaction_tracker.md#inmemoryinteractiontracker
    """
