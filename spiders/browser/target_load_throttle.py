...
# Details: docs/dev/spiders/browser/target_load_throttle.md#_backoff_slowdown_multiplier
...
# see docs/dev/spiders/browser/target_load_throttle.md#record_navigation-live-evidence).
# Details: docs/dev/spiders/browser/target_load_throttle.md#_backoff_proportional_factor
...
# faster. Details: docs/dev/spiders/browser/target_load_throttle.md#_severe_slowdown_multiplier
...
class TargetLoadThrottle:
    ...
    Details: docs/dev/spiders/browser/target_load_throttle.md#targetloadthrottle
    """
    ...
    def __init__(
        ...
        # Details: docs/dev/spiders/browser/target_load_throttle.md#_backoff_seconds
        ...
        # Details: docs/dev/spiders/browser/target_load_throttle.md#_circuit_breaker_until
        self._circuit_breaker_until = 0.0
        # Public fact about the target; 1.0 = no observed slowdown.
        # Details: docs/dev/spiders/browser/target_load_throttle.md#target_slowdown_ratio
    ...
    async def wait_before_navigation(self) -> None:
        ...
        Details: docs/dev/spiders/browser/target_load_throttle.md#wait_before_navigation
        """
    ...
    def record_navigation(self, elapsed_seconds: float) -> None:
        ...
        Details: docs/dev/spiders/browser/target_load_throttle.md#record_navigation
        """
        if (
    ...
    def _trip_circuit_breaker(self) -> None:
        ...
        Details: docs/dev/spiders/browser/target_load_throttle.md#_trip_circuit_breaker
        """
