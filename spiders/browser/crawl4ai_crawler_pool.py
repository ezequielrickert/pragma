...
Details: docs/dev/spiders/browser/crawl4ai_crawler_pool.md#module
"""
...
class Crawl4AICrawlerPool:
    ...
    Details: docs/dev/spiders/browser/crawl4ai_crawler_pool.md#crawl4aicrawlerpool
    """
    ...
    def __init__(self, config: Optional[Crawl4AICrawlerConfig] = None, pool_size: int = 1) -> None:
        ...
        # Details: docs/dev/spiders/browser/crawl4ai_crawler_pool.md#__init__-shared-throttle
        ...
        # Details: docs/dev/spiders/browser/crawl4ai_crawler_pool.md#__init__-active-calls
    ...
    def _least_loaded_crawler(self) -> Crawl4AICrawler:
        ...
        first instance. Details: docs/dev/spiders/browser/crawl4ai_crawler_pool.md#_least_loaded_crawler
        """
    ...
    def _owner_for(self, session_id: str) -> Crawl4AICrawler:
        ...
        Details: docs/dev/spiders/browser/crawl4ai_crawler_pool.md#_owner_for
        """
    ...
    async def _call(self, session_id: str, coro_factory) -> PageState:
        ...
        Details: docs/dev/spiders/browser/crawl4ai_crawler_pool.md#_call
        """
    ...
    def target_slowdown_ratio(self) -> float:
        """Details: docs/dev/spiders/browser/crawl4ai_crawler_pool.md#target_slowdown_ratio"""
    ...
    async def close_session(self, session_id: str) -> None:
        ...
        *then*, not forced back onto the one it happened to start on.
        Details: docs/dev/spiders/browser/crawl4ai_crawler_pool.md#close_session
        """
