...
Details: docs/dev/spiders/page_extraction.md#module
"""
...
# Details: docs/dev/spiders/page_extraction.md#run_accessibility_audit
...
# never end. Details: docs/dev/spiders/page_extraction.md#walk_tab_order
_MAX_TAB_STEPS = 60
...
async def extract_pseudo_styles(page) -> List[Dict[str, Any]]:
    ...
    Returns:
        ...
        has.
    Details: docs/dev/spiders/page_extraction.md#extract_pseudo_styles
    """
    try:
...
async def walk_tab_order(page) -> List[Dict[str, Any]]:
    ...
    Details: docs/dev/spiders/page_extraction.md#walk_tab_order
    """
...
async def run_extraction(page) -> Dict[str, Any]:
    ...
    Details: docs/dev/spiders/page_extraction.md#run_extraction
    """
