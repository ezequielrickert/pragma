...
Details: docs/dev/spiders/crawl4ai_crawler.md#module
"""
...
# Details: docs/dev/spiders/crawl4ai_crawler.md#_action_mark
_ACTION_MARK = "window.__pragma_last_action__"

# Resource types safe to drop when Crawl4AICrawler.block_images is enabled.
# Details: docs/dev/spiders/crawl4ai_crawler.md#_blocked_resource_types
...
# Details: docs/dev/spiders/crawl4ai_crawler.md#_wait_for_new_content
_NAVIGATION_RESTARTS = 3

# _wait_for_new_content's poll step.
# Details: docs/dev/spiders/crawl4ai_crawler.md#_adaptive_wait_step_seconds
...
# Details: docs/dev/spiders/crawl4ai_crawler.md#_stable_hold_seconds
...
# Details: docs/dev/spiders/crawl4ai_crawler.md#_dom_change_signal_js
...
def _is_navigation_context_error(exc: Exception) -> bool:
    ...
    Details: docs/dev/spiders/crawl4ai_crawler.md#_is_navigation_context_error
    """
    msg = str(exc).lower()
...
class Crawl4AICrawlerConfig:
    ...
    Details: docs/dev/spiders/crawl4ai_crawler.md#crawl4aicrawlerconfig
    """
    ...
    # Details: docs/dev/spiders/crawl4ai_crawler.md#viewport
    ...
    # Details: docs/dev/spiders/crawl4ai_crawler.md#audit_accessibility
    ...
    # Details: docs/dev/spiders/crawl4ai_crawler.md#backoff_ceiling_seconds
    ...
    # Details: docs/dev/spiders/crawl4ai_crawler.md#circuit_breaker_cooldown_seconds
    circuit_breaker_cooldown_seconds: float = 10.0


class Crawl4AICrawler:
    """Owns one crawl4ai `AsyncWebCrawler` for the lifetime of an `async with` block.
    Details: docs/dev/spiders/crawl4ai_crawler.md#crawl4aicrawler
    """
    ...
    def __init__(
        ...
        # Details: docs/dev/spiders/target_load_throttle.md#module
    ...
    async def __aenter__(self) -> "Crawl4AICrawler":
        ...
        # Details: docs/dev/spiders/crawl4ai_crawler.md#__aenter__-browserconfig
        ...
        # Details: docs/dev/spiders/crawl4ai_crawler.md#__aenter__-hook-order
        ...
        # Details: docs/dev/spiders/crawl4ai_crawler.md#__aenter__-single-slot-hooks
    ...
    def target_slowdown_ratio(self) -> float:
        ...
        its own worker count. Details: docs/dev/spiders/target_load_throttle.md#target_slowdown_ratio
        """
    ...
    def _log_only_hook(self, hook_name: str):
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#_log_only_hook
        """
    ...
    async def _on_page_context_created(self, page, context, config, **kwargs):
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#_on_page_context_created
        """
        ...
        if self.interaction_timeout_seconds is not None:
            ...
            # Details: docs/dev/spiders/crawl4ai_crawler.md#_on_page_context_created-timeout
    ...
    async def _retry_empty_extraction(self, page, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#_retry_empty_extraction
        """
    ...
    async def _before_retrieve_html(self, page, context, config, **kwargs):
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#_before_retrieve_html
        """
        await _wait_for_new_content(page, self.wait_seconds)
    ...
    async def _on_execution_ended(self, page, context, config, result, **kwargs):
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#_on_execution_ended
        """
        session_id = config.session_id or "default"
        ...
        try:
            ...
            # Details: docs/dev/spiders/crawl4ai_crawler.md#_on_execution_ended-navigation-retry
            try:
        ...
        if isinstance(marked, dict):
            ...
            # Details: docs/dev/spiders/crawl4ai_crawler.md#_on_execution_ended-fallback
    ...
    async def discover_page(
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#discover_page
        """
        ...
        config = CrawlerRunConfig(
            ...
            # Details: docs/dev/spiders/crawl4ai_crawler.md#discover_page-network-capture
    ...
    def _resolved_url(result, requested_url: str) -> str:
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#_resolved_url
        """
    ...
    def _save_markdown(self, session_id: str, result) -> None:
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#_save_markdown
        """
    ...
    async def _interact(self, url: str, session_id: str, js_code: str) -> PageState:
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#_interact
        """
        if self._crawler is None:
            raise RuntimeError(
                "Crawl4AICrawler must be used as an async context manager"
        ...
        config = CrawlerRunConfig(
            ...
            # Details: docs/dev/spiders/crawl4ai_crawler.md#_interact-network-capture
            capture_network_requests=True,
            page_timeout=int(self.page_timeout_seconds * 1000),
            prefetch=self.prefetch,
        )
        ...
        # Details: docs/dev/spiders/crawl4ai_crawler.md#_interact-success-signal
        data = self._stash.pop(session_id, {})
    ...
    async def resync(self, url: str, session_id: str) -> PageState:
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#resync
        """
    ...
    async def click(self, url: str, session_id: str, selector: str) -> PageState:
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#click
        """
    ...
    async def fill(
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#fill
        """
        sel = json.dumps(selector)
    ...
    async def close_session(self, session_id: str) -> None:
        ...
        Details: docs/dev/spiders/crawl4ai_crawler.md#close_session
        """
        if self._crawler is None:
            raise RuntimeError(
                "Crawl4AICrawler must be used as an async context manager"
