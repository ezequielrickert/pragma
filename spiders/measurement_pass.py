...
Details: docs/dev/spiders/measurement_pass.md#module
"""
...
class MeasurementResult:
    ...
    Details: docs/dev/spiders/measurement_pass.md#measurementresult
    """
...
def _navigable(page_url: str) -> bool:
    ...
    Details: docs/dev/spiders/measurement_pass.md#_navigable
    """
...
async def run_measurement_pass(graph_store: GraphStore, site: str, headless: bool = True) -> MeasurementResult:
    ...
    Details: docs/dev/spiders/measurement_pass.md#run_measurement_pass
    """
