...
Details: docs/dev/spiders/debug_log.md#module
"""
...
def loggable_hook_details(args: tuple, kwargs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Details: docs/dev/spiders/debug_log.md#loggable_hook_details
    """
...
def _page_slug(url: str) -> str:
    ...
    Details: docs/dev/spiders/debug_log.md#_page_slug
    """
    cleaned = url.split("#")[0]
...
class CrawlDebugLog:
    ...
    Details: docs/dev/spiders/debug_log.md#crawldebuglog
    """
    ...
    def _ensure_writer(self) -> None:
        ...
        Details: docs/dev/spiders/debug_log.md#_ensure_writer
        """
    ...
    async def _drain(self) -> None:
        ...
        Details: docs/dev/spiders/debug_log.md#_drain
        """
        while True:
    ...
    def log_hook_from_raw(self, hook_name: str, args: tuple, kwargs: Dict[str, Any]) -> None:
        ...
        Details: docs/dev/spiders/debug_log.md#log_hook_from_raw
        """
    ...
    def log_hook(self, hook_name: str, **details: Any) -> None:
        ...
        Details: docs/dev/spiders/debug_log.md#log_hook
        """
    ...
    def log_event(self, message: str, **details: Any) -> None:
        ...
        Details: docs/dev/spiders/debug_log.md#log_event
        """
    ...
    def _append_entry(self, heading: str, details: Dict[str, Any]) -> None:
        ...
        Details: docs/dev/spiders/debug_log.md#_append_entry
        """
        self._fh.write(f"\n## [{_timestamp()}] {heading}\n\n")
    ...
    def save_page_markdown(self, url: str, markdown: str) -> str:
        ...
        Details: docs/dev/spiders/debug_log.md#save_page_markdown
        """
        slug = _page_slug(url)
    ...
    async def close(self) -> None:
        ...
        Details: docs/dev/spiders/debug_log.md#close
        """
...
def prune_old_runs(debug_logs_dir: str, slug: str, keep_last: Optional[int]) -> List[str]:
    ...
    Details: docs/dev/spiders/debug_log.md#prune_old_runs
    """
