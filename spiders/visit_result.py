...
Details: docs/dev/spiders/visit_result.md#module
"""
...
class ComponentInteraction:
    ...
    # Details: docs/dev/spiders/visit_result.md#componentinteractionstale
    stale: bool = False
...
class PageVisitResult:
    ...
    # Details: docs/dev/spiders/visit_result.md#pagevisitresultresolved_url
    resolved_url: str = ""
    # Set when a click/fill mid-pass navigated away before the frontier drained.
    # Details: docs/dev/spiders/visit_result.md#pagevisitresultinterrupted_by_navigation
    interrupted_by_navigation: bool = False
    # Every in-page SPA state this pass switched onto, in order.
    # Details: docs/dev/spiders/visit_result.md#pagevisitresultstate_transitions
