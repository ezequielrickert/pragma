...
Details: docs/dev/spiders/network_filter.md#module
"""
...
# Details: docs/dev/spiders/network_filter.md#_meaningful_resource_types
...
# Details: docs/dev/spiders/network_filter.md#_is_meaningful
...
# Details: docs/dev/spiders/network_filter.md#_auth_scheme
...
def _is_meaningful(event: Dict[str, Any]) -> bool:
    ...
    Returns:
        ...
        `docs/dev/spiders/network_filter.md#_is_meaningful` for why
...
def filter_meaningful_requests(raw_events: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    Details: docs/dev/spiders/network_filter.md#filter_meaningful_requests
    """
    if not raw_events:
        return []
...
def _latency_ms(sent_at: Optional[float], received_at: Optional[float]) -> Optional[int]:
    ...
    Details: docs/dev/spiders/network_filter.md#_latency_ms
    """
