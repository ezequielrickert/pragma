...
Details: docs/dev/crawlers/fill_value_agent.md#module
"""
...
# Details: docs/dev/crawlers/fill_value_agent.md#fill_value_system_instruction
...
async def generate_fill_value(agent: Agent, component: Dict[str, Any], page_description: str = "") -> str:
    ...
    Details: docs/dev/crawlers/fill_value_agent.md#generate_fill_value
    """
...
def make_ai_fill_value_fn(agent: Agent) -> Callable[[Dict[str, Any], str], Awaitable[str]]:
    ...
    Details: docs/dev/crawlers/fill_value_agent.md#make_ai_fill_value_fn
    """
