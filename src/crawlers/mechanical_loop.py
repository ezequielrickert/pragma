...
# Details: docs/dev/crawlers/mechanical_loop.md#_memory_check_interval_seconds
...
# Details: docs/dev/crawlers/mechanical_loop.md#_memory_wait_timeout_seconds
...
class MechanicalCrawlerConfig:
    ...
    # Details: docs/dev/crawlers/mechanical_loop.md#session_recycle_after
    ...
    # Details: docs/dev/crawlers/mechanical_loop.md#memory_ceiling_percent
    ...
    # Details: docs/dev/crawlers/mechanical_loop.md#min_page_concurrency
...
class MechanicalCrawler:
    ...
    async def _recycle_session_if_due(self, browser_session_id: str, visits_since_recycle: int) -> int:
        ...
        Details: docs/dev/crawlers/mechanical_loop.md#_recycle_session_if_due
        """
    ...
    async def _wait_for_memory_headroom(self) -> None:
        ...
        that ceiling faster. Details: docs/dev/crawlers/mechanical_loop.md#_wait_for_memory_headroom
        """
    ...
    def _effective_concurrency(self) -> int:
        ...
        Details: docs/dev/crawlers/mechanical_loop.md#_effective_concurrency
        """
    ...
    async def _wait_for_target_capacity(self, worker_id: int) -> None:
        ...
        Details: docs/dev/crawlers/mechanical_loop.md#_wait_for_target_capacity
        """
    ...
    async def _worker(self, worker_id: int) -> None:
        ...
        `_recycle_session_if_due`. Details: docs/dev/crawlers/mechanical_loop.md#_worker
        """
