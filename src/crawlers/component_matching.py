...
crawl loop. Details: docs/dev/crawlers/component_matching.md#module
"""
...
# Details: docs/dev/crawlers/component_matching.md#fillable_input_types
...
def is_element_not_found(exc: Exception) -> bool:
    ...
    resolve" failure. Details: docs/dev/crawlers/component_matching.md#is_element_not_found
    """
...
def component_identity(component: Dict[str, Any]) -> tuple:
    ...
    Details: docs/dev/crawlers/component_matching.md#component_identity
    """
    return (
        component.get("tag", ""),
        component.get("role", ""),
...
def component_signature(components: List[Dict[str, Any]]) -> str:
    ...
    Details: docs/dev/crawlers/component_matching.md#component_signature
    """
...
def state_transition_key(page_key: str, components: List[Dict[str, Any]]) -> str:
    ...
    any URL change. Details: docs/dev/crawlers/component_matching.md#state_transition_key
    """
...
def component_overlap_ratio(before: List[Dict[str, Any]], after: List[Dict[str, Any]]) -> float:
    ...
    Details: docs/dev/crawlers/component_matching.md#component_overlap_ratio
    """
...
def remap_stale_frontier(
    ...
    Details: docs/dev/crawlers/component_matching.md#remap_stale_frontier
    """
